    ...
    <LuxuryCard className="relative overflow-visible">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center">
          <p className="text-3xl font-medium text-foreground font-display font-data" data-testid="text-time-week">
            {formatTime(weekMinutes)}
          </p>
          <p className="text-xs text-muted-foreground">This week</p>
        </div>
        <div className="text-center">
          <p className="text-3xl font-medium text-foreground font-display font-data" data-testid="text-time-month">
            {formatTime(monthMinutes)}
          </p>
          <p className="text-xs text-muted-foreground">This month</p>
        </div>
        <div className="text-center">
          <p className="text-3xl font-medium text-foreground font-display font-data" data-testid="text-time-total">
