...
- **Route Organization**: 14 domain-specific route modules in `server/routes/` (tasks, approvals, spending, calendar, household-concierge, admin, admin-ops, features, cleaning, user-profile, google-calendar, files, weekly-brief, ask)
